    ...
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen">
      <div className="relative flex min-h-screen w-full flex-col max-w-7xl mx-auto bg-white dark:bg-slate-900 shadow-xl overflow-x-hidden">
        ...
        <header className="flex items-center bg-white dark:bg-slate-900 p-4 pb-2 justify-between sticky top-0 z-10 border-b border-slate-100 dark:border-slate-800 transition-colors">
          ...
          <h2 className="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-tight flex-1 text-center">Categorias</h2>
        ...
        <main className="flex-1 pb-24">
          <div className="px-4 md:px-8 py-6 max-w-3xl mx-auto">
            <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2 text-center md:text-left">Encontre o profissional ideal</h1>
            <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base mb-6 text-center md:text-left">Selecione uma categoria para ver os especialistas disponíveis na sua região.</p>
          ...
          <div className="px-4 md:px-8 mt-12 max-w-5xl mx-auto">
