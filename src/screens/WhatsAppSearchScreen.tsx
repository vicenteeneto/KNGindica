    ...
    <div className="min-h-screen bg-black text-white font-display overflow-x-hidden">
      ...
      <footer className="py-10 px-4 text-center border-t border-white/5 relative z-10">
        <div className="flex justify-center items-center gap-2 mb-2">
          <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">KNGgroup</span>
          <span className="text-slate-700">•</span>
          <span className="text-[10px] font-black uppercase tracking-widest text-primary/60">KNGindica</span>
        </div>
        <p className="text-[9px] text-slate-700 uppercase tracking-widest">Powered by Judite AI · {new Date().getFullYear()}</p>
      </footer>
    </div>
  );
}
