        ...
        {providers.map((p) => (
          ...
          >
            <div className={`relative aspect-[16/9] md:aspect-video rounded-xl overflow-hidden shadow-2xl bg-slate-800 transition-all duration-300 group-hover:scale-105 group-hover:ring-4 ${highlight ? 'group-hover:ring-primary/40' : 'group-hover:ring-white/20'}`}>
              ...
              {/* Rating Mini - Micro version to match category */}
              <div className="absolute top-1.5 right-1.5 bg-black/60 backdrop-blur-md px-1 py-0 rounded text-[7px] font-black flex items-center gap-0.5">
                <span className="material-symbols-outlined text-[8px] text-yellow-500 filled">star</span>
                {p.rating}
              </div>
