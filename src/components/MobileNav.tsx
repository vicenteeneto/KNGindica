...
export default function MobileNav({ onNavigate, currentScreen, role }: MobileNavProps) {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-t border-slate-200 dark:border-white/10 px-4 pt-2 pb-[env(safe-area-inset-bottom,16px)] flex items-center justify-around z-50 shadow-[0_-8px_30px_rgb(0,0,0,0.08)]">
      <button 
